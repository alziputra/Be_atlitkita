...
router.get("/", verifyToken, verifyRole(["admin", "judge"]), matchController.getAllMatches);
router.get("/:id", verifyToken, verifyRole(["admin", "judge"]), matchController.getMatchById);
